...
(2, 'total_timer', '0'),
(3, 'active_year', '2026'),
(4, 'show_correct_during', '1'),
(5, 'show_correct_final', '1'),
(6, 'show_unanswered_final', '1');
...
(8, 5, 'ki-mi kihez-mihez párosul?', 5, '2026-03-31 09:45:43', 2026),
...
(4, 4, 'ls', 1, NULL, NULL),
(5, 4, 'dir', 0, NULL, NULL),
(6, 4, 'list', 0, NULL, NULL),
(7, 6, 'Steven Paul Jobs', 0, NULL, NULL),
(8, 6, 'William Henry Gates, III', 0, NULL, NULL),
(9, 6, 'Linus Torvalds', 1, NULL, NULL),
(10, 3, 'var', 0, NULL, NULL),
(11, 3, 'let', 0, NULL, NULL),
(12, 3, 'const', 1, NULL, NULL),
(13, 3, 'define', 1, NULL, NULL),
(14, 5, 'Hamis', 0, NULL, NULL),
(15, 5, 'Igaz', 1, NULL, NULL),
(16, 2, 'Hamis', 0, NULL, NULL),
(17, 2, 'Igaz', 1, NULL, NULL),
(18, 8, 'Nikola Tesla', 0, NULL, 'váltóáram'),
(19, 8, 'Dennis MacAlistair Ritchie', 0, NULL, 'Brian Kernighan'),
(20, 8, 'Linux kernel', 0, NULL, 'Git verziókezelő'),
(21, 11, 'num = 3', 0, 1, NULL),
(22, 11, 'num *= 16', 0, 2, NULL),
(23, 11, 'print(num)', 0, 3, NULL),
(24, 12, '13', 0, 1, NULL),
(25, 12, '7', 0, 2, NULL),
(26, 12, '0', 0, 3, NULL);
